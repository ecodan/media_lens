...
from src.media_lens.storage import get_shared_storage, shared_storage, _shared_storage
...
def test_shared_storage_proxy_same_as_get_shared(monkeypatch, temp_test_dir):
    ...
    assert hasattr(shared_storage, '_SharedStorageProxy__dict__') or callable(getattr(shared_storage, 'write_text', None))
