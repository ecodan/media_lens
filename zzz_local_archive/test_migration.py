...
def create_test_data(storage: StorageAdapter) -> None:
    ...
    legacy_dirs = ["2025-06-01_120000", "2025-06-02_130000", "2025-06-03_140000"]
    ...
    for legacy_dir in legacy_dirs:
        ...
        for site in sites:
            ...
            storage.write_text(
                f"{legacy_dir}/{site}-clean.html", f"<html>Clean content for {site}</html>"
            )
    ...
    for site in sites:
        interpretation = [
            {
                "question": f"What is happening at {site}?",
                "answer": f"Test interpretation for {site}",
            }
        ]
...
def verify_migration(storage: StorageAdapter) -> bool:
    ...
    legacy_dirs_deleted = ["2025-06-01_120000", "2025-06-02_130000", "2025-06-03_140000"]
    ...
    loose_files = [
        "www.test1.com-interpreted.json",
        "medialens.html",
